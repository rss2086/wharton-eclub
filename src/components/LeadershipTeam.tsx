import namanPicture from '../images/naman-picture.jpeg';
import srineethaPicture from '../images/srineetha-picture.jpeg';
import rohanPicture from '../images/rohan-picture.jpeg';

const people = [
  {
    name: 'Rohan Shah',
    role: 'Co-President',
    imageUrl: rohanPicture,
          ...
          {people.map((person) => (
            <li key={person.name} className="group">
              <div className="relative overflow-hidden rounded-2xl shadow-lg transition-all duration-300 group-hover:scale-105">
                <img alt="" src={person.imageUrl.src} className="w-full h-72 object-cover" />
